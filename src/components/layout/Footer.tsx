...
const Footer: React.FC = () => {
  ...
  const footerLinks = [
    [t('navigation.company'), '/#company-profile'],
    [t('navigation.capabilities'), '/#capabilities'],
      ...
      <div className="container-custom py-14 md:py-20">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <Link to="/" className="inline-flex items-center gap-4" aria-label={t('navigation.homeLabel')}>
          ...
          <div className="lg:col-span-3 lg:col-start-6">
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-copper-light">{t('footer.footprint')}</h2>
            <div className="mt-7 space-y-7">
              <div>
                <div className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.1em]">
                  ...
                  {t('footer.singaporeHeadquarters')}
                </div>
          ...
          <div className="lg:col-span-3 lg:col-start-10">
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-copper-light">{t('footer.navigate')}</h2>
            <nav className="mt-6 grid gap-1" aria-label={t('navigation.footerLabel')}>
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 border-t border-white/[0.12] pt-7 text-xs text-white/40 md:grid-cols-2 md:items-center">
          ...
          <p className="flex items-center gap-2 md:justify-end"><MapPin className="h-3.5 w-3.5" aria-hidden="true" /> {t('footer.markets')}</p>
        </div>
      </div>
    </footer>
  );
